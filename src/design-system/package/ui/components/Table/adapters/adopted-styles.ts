// Shared Vanilla Extract stylesheet adoption for the Table family adapters.
// Mirrors the pattern used by other Loom components (e.g. MetricCard): locate
// the constructed stylesheet that contains a known VE anchor class and clone it
// as an adoptable sheet for the shadow root.
