// Shared Vanilla Extract stylesheet adoption for the Sidebar family adapters.
// Mirrors the pattern used by the Table family: locate the constructed
// stylesheet that contains a known VE anchor class and clone it as an
// adoptable sheet for the shadow root.
